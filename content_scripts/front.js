var Front = (function() {
  ...
  function getAllAnnotations() {
    return [Normal.mappings, Visual.mappings, Insert.mappings].map(getAnnotations).reduce(function(a, b) {
      return a.concat(b);
    });
  }
  ...
  self.getFrameId = function() {
    if (document.body.offsetWidth && document.body.offsetHeight && document.body.innerText && runtime.conf.ignoredFrameHosts.indexOf(window.origin) === -1 && !window.frameId) {
